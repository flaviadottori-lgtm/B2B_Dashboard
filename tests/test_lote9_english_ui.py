...
try:
    ...
    checks = {
        ...
        'Description includes "Aggregated structural index (2021)"': 'Aggregated structural index (2021)' in content,
        'Source text "Source: IBGE / SIDRA"': 'Source: IBGE / SIDRA' in content,
        'NO Portuguese em map section': 'Índice Estrutural' not in content or content.count('Índice Estrutural') < 3,  # Permitir em outras seções
