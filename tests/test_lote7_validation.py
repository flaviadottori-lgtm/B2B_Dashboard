...
try:
    ...
    checks = {
        ...
        'Hover "Índice Estrutural"': "Índice Estrutural:" in content
        and "%{customdata[0]:.1f}" in content,
        ...
        "Region agregado no groupby": '.agg(weighted=("_w", "sum"), units=("units", "sum"), region=("region", "first"))'
        in content,
