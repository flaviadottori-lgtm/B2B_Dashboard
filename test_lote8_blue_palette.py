...
try:
    ...
    checks = {
        'Escala azul customizada': '["#0B1F33", "#143A5A", "#1F5C8B", "#3A7CA5", "#A9CCE3"]' in content,
        'Não há "Cividis"': 'color_continuous_scale="Cividis"' not in content,
        'Range color fixo': 'range_color' not in content or 'range_color=None' in content or 'range_color=' not in content,
